...
//register.php de ki formdan gelen kuladi ve sifre post verilerini $kuladi ve $sifre değişkenlerine eşitledik
$kuladi = $_POST['kuladi'];
$sifre = $_POST['sifre'];
...
//kayıt işlemi bitince login.php ye yönlendiriyoruz
   ...
   if( $kontrol->rowCount() == "0" ){
      $db->query("INSERT INTO adminn SET kullaniciadi='{$_POST["kuladi"]}', sifresi='{$_POST["sifre"]}'");
      echo "Kayıt Başarılı..<br>";
   }else{
      echo "Kullanıcı adı daha önce alınmış tekrar deneyin<br>"; 
   } //kayıt işlemince göre yönlendirme
